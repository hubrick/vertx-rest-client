...
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    public MimeType(String type, String subtype, Map<String, String> parameters) {
        checkArgument(!Strings.isNullOrEmpty(type), "type must not be empty");
        checkArgument(!Strings.isNullOrEmpty(subtype), "subtype must not be empty");
        checkToken(type);
        checkToken(subtype);
    ...
    protected void checkParameters(String attribute, String value) {
        checkArgument(!Strings.isNullOrEmpty(attribute), "parameter attribute must not be empty");
        checkArgument(!Strings.isNullOrEmpty(value), "parameter value must not be empty");
