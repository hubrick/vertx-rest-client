...
import com.hubrick.vertx.rest.common.ConvertRequest;
import com.hubrick.vertx.rest.common.UserResponse;
import com.hubrick.vertx.rest.common.UserSearchResponse;
...
public class RxRestClientIntegrationTest extends AbstractFunctionalTest {
    ...
    public void testMultipartByteBuffer(TestContext testContext) throws Exception {
        testMultipart(testContext, new Part(ByteBuffer.wrap(loadFile("/com/hubrick/vertx/rest/common/test.gif")), "test.gif").setContentType(MediaType.IMAGE_GIF));
    }

    @Test
    public void testMultipartByteBuf(TestContext testContext) throws Exception {
        testMultipart(testContext, new Part(Unpooled.wrappedBuffer(loadFile("/com/hubrick/vertx/rest/common/test.gif")), "test.gif").setContentType(MediaType.IMAGE_GIF));
    }

    @Test
    public void testMultipartByteArray(TestContext testContext) throws Exception {
        testMultipart(testContext, new Part(loadFile("/com/hubrick/vertx/rest/common/test.gif"), "test.gif").setContentType(MediaType.IMAGE_GIF));
    }
            ...
            restClientRequest.end(parts);
                ...
                restClientResponse -> {
                    try {
                        ...
                        assertThat(testContext, image.toByteArray(), is(loadFile("/com/hubrick/vertx/rest/common/test.gif")));
    ...
    public void testSimpleRxFlow(TestContext testContext) throws Exception {
        getMockServerClient().when(
                ...
                response()
                        ...
                        .withBody(toByteArray(getResource(RxRestClientIntegrationTest.class, "/com/hubrick/vertx/rest/common/userSearchResponse.json")))
        );
        ...
        getMockServerClient().when(
                ...
                response()
                        .withStatusCode(200)
                        .withHeader(Header.header("Content-Type", "application/json;charset=UTF-8"))
                        .withBody(toByteArray(getResource(RxRestClientIntegrationTest.class, "/com/hubrick/vertx/rest/common/userResponse1.json")))
        );
        ...
        getMockServerClient().when(
                ...
                response()
                        .withStatusCode(200)
                        .withHeader(Header.header("Content-Type", "application/json;charset=UTF-8"))
                        .withBody(toByteArray(getResource(RxRestClientIntegrationTest.class, "/com/hubrick/vertx/rest/common/userResponse2.json")))
        );
